...
FOR EACH ROW
BEGIN
  INSERT INTO audit_log_vendedores(id_vendedores, razonsocial_vendedor, cuit_vendedor, rubro_id, direccion_vendedor,
  cp_vendedor, telefono_vendedor, email_vendedor, reputacion, accion, fecha_modificacion, hora_modificacion, usuario)
  VALUES (new.id_vendedores, new.razonsocial_vendedor,
  new.cuit_vendedor, new.rubro_id, new.direccion_vendedor, new.cp_vendedor, new.telefono_vendedor, new.email_vendedor,
  new.reputacion,'creación de registro', CURDATE(), CURTIME(),current_user());
END;
//
DELIMITER ;
...
BEGIN
  INSERT INTO audit_log_vendedores(id_vendedores, razonsocial_vendedor, cuit_vendedor, rubro_id, direccion_vendedor,
  cp_vendedor, telefono_vendedor, email_vendedor, reputacion, accion, fecha_modificacion, hora_modificacion, usuario)
  VALUES (old.id_vendedores, old.razonsocial_vendedor,
  old.cuit_vendedor, old.rubro_id, old.direccion_vendedor, old.cp_vendedor, old.telefono_vendedor, old.email_vendedor,
  old.reputacion,'actualización de registro', CURDATE(), CURTIME(),current_user());
END;
//
DELIMITER ;
...
FOR EACH ROW
BEGIN
  INSERT INTO audit_log_exposiciones(id_exposiciones, categoria_exp, comision_exp, accion, fecha_modificacion, hora_modificacion, usuario)
  VALUES (new.id_exposiciones, new. categoria_exp, new.comision_exp,'creación de registro', CURDATE(), CURTIME(),current_user());
END;
//
DELIMITER ;
...
BEFORE UPDATE ON exposiciones
FOR EACH ROW
BEGIN
  INSERT INTO audit_log_exposiciones(id_exposiciones, categoria_exp, comision_exp, accion, fecha_modificacion, hora_modificacion, usuario)
  VALUES (old.id_exposiciones, old. categoria_exp, old.comision_exp,'actualización de registro', CURDATE(), CURTIME(),current_user());
END;
//
DELIMITER ;
